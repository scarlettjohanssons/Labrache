...
public class Cars {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Кількість автомобілів: ");
        try {
        k = sc.nextInt(); }catch (Exception e) {System.out.print(e+" Введіть ще раз: "); sc.next(); k = sc.nextInt();}
        sc.nextLine();
        for (int i = 0; i<k; i++) {
        ...
        System.out.println();
            ...
            try {
            t = sc.nextInt(); } catch (Exception e) {System.out.print(e+" Введіть ще раз: "); sc.next(); t = sc.nextInt();}
        String s1 = "";
        String s2 = "";
        boolean f = false;
        switch (t) {
            case 1:
                ...
                try {
                s1 = sc.nextLine();
                s1 = sc.nextLine(); } catch (Exception e) {System.out.println(e); s1 = sc.nextLine();}
                for (int i = 0; i<k; i++) {
                    try {
                    if (mark.get(i).equals(s1)) {System.out.println(id_num.get(i)+"  "+ mark.get(i)+ "  "+ model.get(i) + "  "+ year.get(i)+"  "+ color.get(i)+"  "+ num.get(i)+"  "+ price.get(i)); f = true;} } catch (Exception e) {System.out.println(e);}
            ...
            case 2:
                ...
                try {
                s1 = sc.nextLine();
                s1 = sc.nextLine(); } catch (Exception e) {System.out.print(" Введіть ще раз: ");}
                System.out.print("Введіть кількість років: ");
                s2 = sc.nextLine();
                for (int i = 0; i<k; i++) {
                    try {
                    if (model.get(i).equals(s1) && (2018-Integer.parseInt(year.get(i))) > Integer.parseInt(s2)) {System.out.println(id_num.get(i)+"  "+ mark.get(i)+ "  "+ model.get(i) + "  "+ year.get(i)+"  "+ color.get(i)+"  "+ num.get(i)+"  "+ price.get(i)); f = true;} } catch (Exception e) {System.out.println(e);}
            ...
            case 3:
                ...
                try {
                s1 = sc.nextLine();
                s1 = sc.nextLine(); } catch (Exception e) {System.out.println(e);}
                System.out.print("Введіть ціну: ");
                s2  = sc.nextLine();
                for (int i = 0; i<k; i++) {
                    try {
                    if (Integer.parseInt(year.get(i)) == Integer.parseInt(s1) && Integer.parseInt(price.get(i)) > Integer.parseInt(s2)) {System.out.println(id_num.get(i)+"  "+ mark.get(i)+ "  "+ model.get(i) + "  "+ year.get(i)+"  "+ color.get(i)+"  "+ num.get(i)+"  "+ price.get(i)); f = true;}} catch (Exception e) {System.out.println(e);}
